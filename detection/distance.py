...
def run_video_detection_with_distance(weights_path, source_path, altitude, initial_latitude, initial_longitude, output_dir="output", conf_threshold=0.25):
    """
    Run YOLOv5 detection on a video and calculate the distance of a random detected human.
...
if __name__ == "__main__":
    print("Starting YOLOv5 video detection with distance calculation...")
    run_video_detection_with_distance(weights_path, source_path, altitude, initial_latitude, initial_longitude, output_dir)
